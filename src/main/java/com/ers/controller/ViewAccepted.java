...
/**
 * Servlet implementation class ViewAccepted
 */
public class ViewAccepted extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ApproveDenyEntity> adlist=employeeService.viewapproved();
		out.println("<table width=200 height=200 border=1>");
		out.println("<caption>All Approved reimbursement list</caption>");
